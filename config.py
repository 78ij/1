...
def add_base_args(parser):
    ...
    parser.add_argument('--category', type=str, default='MasterBedroom', help='object category')
...
def add_train_ae_args(parser):
    ...
    parser.add_argument('--max_child_num', type=int, default=20, help='maximum number of children per parent')
    ...
    parser.add_argument('--loss_weight_center', type=float, default=10.0, help='weight for the center recon loss')
    parser.add_argument('--loss_weight_scale', type=float, default=10.0, help='weight for the scale recon loss')
    parser.add_argument('--loss_weight_same', type=float, default=1.0, help='weight for the same loss')
    parser.add_argument('--loss_weight_moveable', type=float, default=0.0, help='weight for the moveable loss')
    parser.add_argument('--loss_weight_moveable_recon', type=float, default=5.0, help='weight for the moveable reconstruction loss')
    parser.add_argument('--loss_weight_rootcode', type=float, default=1.0, help='weight for the root code MSE loss')
    ...
    parser.add_argument('--loss_weight_anchor', type=float, default=5.0, help='weight for the anchor reconstruction loss')
    ...
    parser.add_argument('--loss_weight_semantic', type=float, default=3.0, help='weight for the semantic reconstruction loss')
    parser.add_argument('--loss_weight_edge_exists', type=float, default=3.0, help='weight for the "edge exists" loss')
...
def add_result_args(parser):
    ...
    parser.add_argument('--model_epoch', type=int , help='model at what epoch to use (set to < 0 for the final/most recent model)')
